...
#
# ------------------------------------------------------------------------------
func toUuid*(x: array[16, uint8]): Uuid =
  result = UUid(uuidType: Uuid128, uuid128: x)

# ------------------------------------------------------------------------------
#
# ------------------------------------------------------------------------------
func toUuid*(x: array[2, uint8]): Uuid =
  result = UUid(uuidType: Uuid16, uuid16: x)

# ------------------------------------------------------------------------------
#
# ------------------------------------------------------------------------------
proc `==`*(a, b: Uuid): bool =
  if a.uuidType != b.uuidType:
    return
  case a.uuidType
  of Uuid16:
    result = (a.uuid16 == b.uuid16)
  of Uuid128:
    result = (a.uuid128 == b.uuid128)
  else:
    discard
